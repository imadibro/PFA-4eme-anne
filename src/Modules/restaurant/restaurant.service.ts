...
export class RestaurantService {
  ...
  async findAll(page: number, limit: number, search?: string): Promise<PaginatedResult<RestaurantDto>> {
    try {
      ...
      return { data: restaurantResponse, total, page, limit: validLimit, totalPages };
    } catch (error) {
